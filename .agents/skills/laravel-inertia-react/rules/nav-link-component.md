                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="flex h-16 justify-between">
                        ...
                        <div className="flex items-center">
                            ...
                            <Link href={route('logout')} method="post" as="button" className="ml-4 text-sm text-gray-700 hover:text-gray-900">
                                Log Out
                            </Link>
                        </div>
                    </div>
...
function AdvancedLinkExamples() {
    return (
        <div className="space-y-4">
            ...
            <Link href={route('posts.favorite', { post: 1 })} method="post" as="button" className="text-blue-600 hover:underline">
                Add to Favorites
            </Link>
