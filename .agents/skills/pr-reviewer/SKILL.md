...
6. **Present Report & Ask for User Approval (CRITICAL)**:
    ...
    - **Tanyakan kepada pengguna**: _"Apakah laporan ini sudah sesuai dan ingin diposting ke GitHub PR #<PR_NUMBER>?"_
    - \*_TUNGGU persetujuan tertulis dari pengguna (misal: "Ya", "Kirim", atau "Proceed"). JANGAN memposting komentar sebelum ada persetujuan._
