    ...
    public function up(): void
    {
        ...
        if (DB::getDriverName() !== 'sqlite') {
            ...
            DB::statement("
                ...
                COMMENT 'DEPRECATED v1.1 - Use sub_category_id relation. Remove in v1.2'
            ");

            DB::statement("
                ALTER TABLE evaluation_indicators
                MODIFY sub_category VARCHAR(100) NULL
                COMMENT 'DEPRECATED v1.1 - Use sub_category_id relation. Remove in v1.2'
            ");
    ...
    public function down(): void
    {
        ...
        if (DB::getDriverName() !== 'sqlite') {
            ...
            DB::statement("
                ...
                COMMENT 'Kategori utama, e.g., Kelengkapan Administrasi'
            ");

            DB::statement("
                ALTER TABLE evaluation_indicators
                MODIFY sub_category VARCHAR(100) NULL
                COMMENT 'Sub-kategori (optional)'
            ");
        }
    }
};
