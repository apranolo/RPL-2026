...
Kedua proyek berjalan dalam satu *codebase* monolith Laravel yang sama (satu repository GitHub bersama), dengan pembagian domain yang jelas melalui konvensi penamaan namespace.
...
Saat sebuah Issue di-*publish* oleh Kelas G, artikel di dalamnya harus muncul di portal publik JurnalMu yang dikelola Kelas B.
