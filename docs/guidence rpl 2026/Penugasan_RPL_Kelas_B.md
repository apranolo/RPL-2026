...
*(Modul untuk pengajuan proposal, upload dokumen, validasi, dan skema penelitian. Dikerjakan oleh 8 Mahasiswa)*
...
*(Modul penunjukan reviewer, form penilaian, rekap hasil review. Dikerjakan oleh 8 Mahasiswa)*
...
*(Modul pengelolaan kontrak yang lolos seleksi dan pencairan dana termin. Dikerjakan oleh 8 Mahasiswa)*
...
*(Modul laporan kemajuan, dokumen monev, catatan evaluasi reviewer. Dikerjakan oleh 8 Mahasiswa)*
...
*(Modul input publikasi, paten, produk, buku. Dikerjakan oleh 9 Mahasiswa)*
...
*(Modul statistik, rekap, grafik, dan export PDF/Excel. Dikerjakan oleh 9 Mahasiswa)*
