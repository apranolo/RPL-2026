...
Dokumen ini berisi spesifikasi visual, tata letak, antarmuka TypeScript, dan alur interaksi untuk pembuat halaman (_view_) dan komponen di Modul 2 Kelas G.
...
| `KeywordInput.tsx`          | `resources/js/components/KeywordInput.tsx`                   | ARIEL ZIJANT ATHALLAH  | Komponen input kata kunci interaktif berbasis _chips/tags_ (ditekan Enter).               |
