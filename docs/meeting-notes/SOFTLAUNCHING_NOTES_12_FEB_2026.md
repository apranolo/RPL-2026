# Soft Launching JurnalMu - 12 Februari 2026

**Meeting Date:** 12 Februari 2026  
**Duration:** 57 minutes  
**Recording:** [View on Fathom](https://fathom.video/share/r2gyT2ssyQbMyfEPM1aQF33JqQJRPpVf)

## Executive Summary

Pertemuan soft launching JurnalMu, portal baru untuk jurnal akademik PTMA (Perguruan Tinggi Muhammadiyah Aisyiyah). Portal ini bertujuan untuk menyentralisasi semua jurnal PTMA, menyediakan direktori tunggal untuk discovery dan kolaborasi, serta meningkatkan kualitas dan visibilitas jurnal-jurnal di lingkungan Muhammadiyah.

---

## Key Takeaways

1. **JurnalMu Launched**: Portal baru (jurnalmu.org) telah diluncurkan untuk menyentralisasi semua jurnal PTMA, menyediakan direktori tunggal untuk discovery dan kolaborasi.

2. **LPPM Sebagai Gatekeeper**: LPPM universitas harus menyetujui semua registrasi user dan jurnal baru, memastikan kualitas data dan mencegah entry yang tidak sah.

3. **Editor-Driven Data Entry**: Editor jurnal bertanggung jawab untuk meregistrasi jurnal mereka sendiri, mendistribusikan beban kerja dan memastikan akurasi data.

4. **Visi Masa Depan**: Portal akan berkembang menjadi ekosistem lengkap dengan forum editor/reviewer, fitur pertukaran artikel, dan analisis citasi berbasis AI.
...
- Platform kolaborasi antar pengelola jurnal
...
- Visibilitas terbatas untuk penulis dan pembaca

**Target:** Membuat platform terpadu untuk mengatasi masalah ini.

### 2. The Solution: JurnalMu Portal
...
- **Data Harvesting**: Menggunakan protokol OAI-PMH untuk mengambil metadata artikel (judul, abstract, link PDF) dari jurnal berbasis OJS, mirip Garuda
...
4. Update data jurnal secara berkala
...
- Citasi tracking
- Academic reputation
- Regulasi nasional untuk syarat kelulusan & kenaikan jabatan

### 5. Penguatan Jurnal Ilmiah: 7 Poin Utama

1. **Focus & Scope**: Penguatan fokus dan lingkup jurnal
2. **Editorial Board**: Penguatan editorial board (min. 4 negara untuk akreditasi maksimal)
3. **Reviewers**: Penguatan reviewer pool (min. 4 negara)
4. **Author Diversity**: Kualitas manuskrip & diversity penulis (min. 6 negara)
5. **Citation Control**: Kontrol citasi di Dimensions/Scopus
6. **COPE Compliance**: Kepatuhan 16 prinsip transparansi & best practices (COPE, DOAJ, WAME)
7. **AI Policy**: Generative AI policy untuk submission & review
...
- Harapan: Kumpul bareng secara rutin untuk diskusi distribusi artikel
...
3. Klik "Daftar"
4. **Menunggu approval dari LPPM universitas**
5. Setelah approved → Login
6. Daftar jurnal yang dikelola
...
- Breakdown jurnal per bidang ilmu
...
- View seluruh user di universitas
...
- ISSN
- E-ISSN
- OAI-PMH URL (untuk harvesting)
- Akreditasi Sinta (jika ada)
- Indeksasi (Scopus, Doaj, dll)
- Periode akreditasi/indeksasi
- Bidang ilmu
- Link jurnal
...
**Similar to:** Garuda (Garba Rujukan Digital)
...
- **Bu Sulis** - UNISA
- **Representatives from:** UMT, UM Surabaya, UMS, UMSU, UAD, dan kampus-kampus unggul lainnya
...
- [ ] Semua LPPM dari 21 PTMA unggul terdaftar
- [ ] Minimal 80% jurnal dari 21 PTMA unggul terdaftar
- [ ] Email notification system aktif
- [ ] Dashboard LPPM fully functional
- [ ] Dokumentasi lengkap tersedia

### Mid-term Goals (Month 4-6)

- [ ] Article discovery feature live
- [ ] Metadata harvesting via OAI-PMH aktif
- [ ] Assessment tools untuk akreditasi tersedia
- [ ] Forum editor tersedia
- [ ] Pertemuan koordinasi pertama

### Long-term Goals (Year 1)

- [ ] Assessment tools untuk indeksasi tersedia
- [ ] Reviewer database established
- [ ] Article exchange feature live
- [ ] AI-powered analysis features
- [ ] Ekspansi ke semua PTMA (150+ universitas)
- [ ] Target: 1000+ jurnal terdaftar

---

## Important Links

- **Portal:** [jurnalmu.org](https://jurnalmu.org)
- **Meeting Recording:** [View on Fathom](https://fathom.video/share/r2gyT2ssyQbMyfEPM1aQF33JqQJRPpVf)
- **Documentation:** Will be available at DOCS.jurnalmu.org
...
> "Quality gatekeeper... Memastikan kualitas dan kualitas data jurnal yang masuk ke sistem JurnalMu."

---

## Meeting Transcript

[Full transcript available in original document - 56 minutes]
...
- [38:00-44:15] Diskusi feedback & future features
- [44:15-56:00] Demo teknis & registration flow

**Key Q&A:**

**Q (Bu Yessi - UMY):** Apakah ada button untuk tukar-menukar artikel?
**A:** Belum prioritas, akan dikembangkan di fase selanjutnya melalui forum editor.

**Q (Pak Jun Harbi - UM Palembang):** Bagaimana dengan database reviewer?
**A:** Akan diakomodasi, saat ini risetmu sudah punya ~300 reviewer yang bisa diperluas.
...
**Document Created:** 14 Februari 2026  
...
- Meeting dilaksanakan dengan lancar, durasi 57 menit
- Sistem sudah established dan siap digunakan
- Email notification akan segera diaktifkan
- Grup WhatsApp koordinasi akan dibuat setelah meeting
