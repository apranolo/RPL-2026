                ...
                {!loading &&
                    ...
                    researchList.map((research, index) => (
                        ...
                        >
                            {/* Rank Badge */}
                            <div
                                className={`flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold shadow-sm mt-0.5 ${MEDAL_STYLES[index] ?? 'bg-white/10 text-white/50 border border-white/10'}`}
                            >
                                {index + 1}
                            </div>
