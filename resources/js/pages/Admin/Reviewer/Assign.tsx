...
export default function AssignReviewer({ proposals = [], reviewers = [], selectedProposalId }: Props) {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4 sm:p-6">
                <div className="relative overflow-hidden rounded-xl border border-sidebar-border/70 bg-white p-6 dark:border-sidebar-border dark:bg-neutral-950">
                    ...
                    <div className="mb-8 flex items-center gap-4 border-b pb-6 dark:border-neutral-800">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold">Penunjukan Reviewer</h1>

                            <p className="text-sm text-muted-foreground">Tugaskan reviewer yang tepat untuk menilai proposal.</p>
                        </div>
                    </div>
                    ...
                    <div className="mx-auto max-w-2xl rounded-lg border border-sidebar-border/70 bg-card p-6 dark:border-sidebar-border">
                        <form onSubmit={submit} className="space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                {errors.proposal_id && <p className="text-sm text-red-500">{errors.proposal_id}</p>}
                            </div>
            ...
            <AssignModal open={openModal} onClose={() => setOpenModal(false)} onConfirm={confirmAssign} loading={processing} />
        </AppLayout>
    );
}
