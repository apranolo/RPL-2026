                        ...
                        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                            ...
                            <div className="flex flex-col gap-4 py-4 md:col-span-2">
                                <div className="flex items-center space-x-2">
                                    <Switch id="is_active" checked={data.is_active} onCheckedChange={(val) => setData('is_active', true)} />
                                    <Label htmlFor="is_active">Active (Visible)</Label>
                                </div>
                                <div className="flex items-center space-x-2">
                                    <Switch id="is_featured" checked={data.is_featured} onCheckedChange={(val) => setData('is_featured', false)} />
