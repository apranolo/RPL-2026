 ...
 * Allows Admin Kampus to update journal information.
 *
...
export default function JournalsEdit({ journal, scientificFields, sintaRankOptions, indexationOptions }: Props) {
    ...
    const initialData: Partial<JournalFormData> = {
        ...
        user_id: journal.user_id ? String(journal.user_id) : '',
    };
            ...
            <div className="py-6">
                <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
                    <div className="mb-6">
                        ...
                        <p className="mt-1 ml-10 text-gray-600 dark:text-gray-400">Update the details of the journal</p>
                    </div>

                    <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                        <JournalForm 
                            submitUrl={route('admin-kampus.journals.update', journal.id)}
