            ...
            <div className="container mx-auto space-y-6 px-4 py-6 sm:px-6 lg:px-8">
                <div className="flex flex-col space-y-4 md:flex-row md:items-center md:justify-between md:space-y-0">
                    <div>
                        ...
                        <p className="text-muted-foreground">Manage incoming journal submissions and editorial assignments.</p>
                    </div>
                </div>
                            ...
                            <Card key={submission.id} className="transition-shadow hover:shadow-md">
                                <CardHeader className="flex flex-row items-start justify-between space-y-0 pb-2">
                                    <div className="space-y-1">
                                        <CardTitle className="text-base leading-none font-semibold">{submission.title}</CardTitle>
