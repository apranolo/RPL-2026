                                ...
                                {agendas.links.map((link, index) => {
                                    if (link.label.includes('Previous')) {
                                        return (
                                            <PaginationItem key={index}>
                                                {link.url ? (
                                                    <PaginationPrevious onClick={() => router.get(link.url as string)} />
                                                ) : (
                                    ...
                                    if (link.label.includes('Next')) {
                                        return (
                                            <PaginationItem key={index}>
                                                {link.url ? (
                                                    <PaginationNext onClick={() => router.get(link.url as string)} />
                                                ) : (
                                    ...
                                    return (
                                        <PaginationItem key={index}>
                                            <PaginationLink
                                                ...
                                                className={link.url ? 'cursor-pointer' : 'opacity-50 cursor-default'}
                                            >
                                                {link.label}
                                            </PaginationLink>
                                        </PaginationItem>
