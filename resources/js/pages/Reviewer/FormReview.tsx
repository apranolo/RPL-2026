...
import { AlertCircle, ArrowLeft, Calendar, FileText, FileUp, Info, Award, Save, Edit3, Download } from 'lucide-react';
            ...
            <div className="container mx-auto py-6 px-4 max-w-7xl">
                ...
                <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center gap-3">
                        <Link
                            href={route('reviewer.assignments.show', assignment.id)}
                            className="inline-flex items-center justify-center p-2 rounded-lg border bg-background hover:bg-muted transition-colors"
                        >
                        ...
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground">
                                Silakan periksa proposal dan isi penilaian evaluasi di bawah ini.
                            </p>
                        </div>
                    </div>
                    <Badge variant={isEditMode ? "default" : "secondary"} className="text-xs py-1 px-3">
                    ...
                    <div className="lg:col-span-5 space-y-6">
                        ...
                        <Card className="shadow-sm border border-border/60 overflow-hidden">
                            <CardHeader className="bg-muted/30">
                                ...
                                <CardDescription>
                                    Detail pendaftaran pembinaan dari institusi pengusul
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="pt-6 space-y-4 text-sm">
                                <div>
                                    ...
                                    <p className="font-semibold text-foreground text-sm mt-0.5">
                                        {assignment.registration?.pembinaan?.name}
                                    </p>
                                    <p className="text-xs text-muted-foreground mt-1">
                                        Kategori: {assignment.registration?.pembinaan?.category === 'akreditasi' ? 'Pendampingan Akreditasi' : 'Pendampingan Indeksasi'}
                                    </p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p className="font-semibold text-foreground text-sm mt-0.5">
                                        {assignment.registration?.journal?.title}
                                    </p>
                                    <p className="text-xs text-muted-foreground mt-1 flex flex-wrap gap-2">
                                        {assignment.registration?.journal?.issn && (
                                            <span>ISSN: {assignment.registration?.journal?.issn}</span>
                                        )}
                                        {assignment.registration?.journal?.e_issn && (
                                            <span>E-ISSN: {assignment.registration?.journal?.e_issn}</span>
                                        )}
                                    </p>
                                </div>
                        ...
                        <Card className="shadow-sm border border-border/60">
                            <CardHeader className="bg-muted/30">
                                ...
                                <CardDescription>
                                    Unduh dokumen proposal untuk dipelajari
                                </CardDescription>
                            </CardHeader>
                                            ...
                                            >
                                                <div className="flex items-center gap-3 overflow-hidden pr-2">
                                                    ...
                                                    <div className="overflow-hidden">
                                                        <p className="font-medium text-xs text-foreground truncate max-w-[200px]" title={attachment.file_name}>
                                                ...
                                                <a
                                                    ...
                                                    className="inline-flex items-center justify-center p-2 rounded-md hover:bg-muted text-primary transition-colors border"
                                                    title="Unduh file"
                                                >
                        ...
                        <form onSubmit={submit}>
                            <Card className="shadow-sm border border-border/60">
                                <CardHeader className="bg-muted/30">
                                    ...
                                    <CardDescription>
                                        Berikan nilai dan tanggapan formal terhadap proposal pembinaan
                                    </CardDescription>
                                </CardHeader>
                                ...
                                <CardFooter className="bg-muted/20 border-t py-4 flex justify-between gap-3">
                                    <Button
                                        type="button"
                                        variant="outline"
                                        asChild
