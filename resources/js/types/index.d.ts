...
// Revision types (versioning dokumen)
export interface SubmissionFile {
    ...
    mime_type?: string;
    notes?: string;
    /** Computed: ukuran file dalam format human-readable */
    file_size_human?: string;
    /** Computed: URL unduhan dari disk public */
    download_url?: string;
    created_at: string;
    updated_at: string;
    uploader?: User;
...
export interface RevisionRound {
    ...
    /** Computed: label status dalam Bahasa Indonesia */
    status_label?: string;
    /** Computed: warna badge (yellow|blue|green|red) */
    status_color?: string;
    created_at: string;
    updated_at: string;
    deleted_at?: string;
