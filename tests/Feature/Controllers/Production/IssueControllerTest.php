...
class IssueControllerTest extends TestCase
{
    ...
    public function test_index_allows_authorized_journal_owner()
    {
        ...
        $response = $this->actingAs($user)->get(route('user.journals.issues.index', $journal->id));
    ...
    public function test_index_allows_admin_kampus_of_same_university()
    {
        ...
        $response = $this->actingAs($adminKampus)->get(route('user.journals.issues.index', $journal->id));
    ...
    public function test_index_allows_super_admin()
    {
        ...
        $response = $this->actingAs($superAdmin)->get(route('user.journals.issues.index', $journal->id));
    ...
    public function test_preview_allows_authorized_journal_owner()
    {
        ...
        $response = $this->actingAs($user)->get(route('user.journals.issues.preview', [
            'journal' => $journal->id,
            'volume' => 1,
            'issue' => 2,
        ]));
    ...
    public function test_publish_allows_authorized_journal_owner()
    {
        ...
        $response = $this->actingAs($user)->post(route('user.journals.issues.publish', [
            'journal' => $journal->id,
            'volume' => 1,
            'issue' => 2,
        ]));
